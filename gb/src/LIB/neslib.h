#ifndef B22BF533_FA3E_429F_8AEE_DADEA3B1BDEB
#define B22BF533_FA3E_429F_8AEE_DADEA3B1BDEB
...
void pal_bright(unsigned char bright) { (void)bright; }
...
void music_play(unsigned char song) { (void)song; }
...
void music_pause(unsigned char pause) { (void)pause; }

// //play FamiTone sound effect on channel 0..3

void sfx_play(unsigned char sound,unsigned char channel) { (void)sound; (void)channel; }
...
void vram_adr(unsigned int adr) { (void)adr; }
...
void vram_unrle(const unsigned char *data) { (void)data; }
...
#define PAD_A			J_A
#define PAD_B			J_B
#define PAD_SELECT		J_SELECT
#define PAD_START		J_START
#define PAD_UP			J_UP
...
#endif /* B22BF533_FA3E_429F_8AEE_DADEA3B1BDEB */
